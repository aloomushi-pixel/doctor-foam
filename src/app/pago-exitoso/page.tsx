...
function SuccessContent() {
    ...
    const [bookingPayload, setBookingPayload] = useState<string | null>(null);
    ...
    useEffect(() => {
        ...
        if (payload) setBookingPayload(payload);
    }, []);
            ...
            >
                <section className="section-padding">
                    <div className="container" style={{ maxWidth: "700px", textAlign: "center" }}>
                        ...
                        >
                            ¡Gracias por tu pago! Tu orden ha sido procesada correctamente de forma segura.
                            <br/><br/>
                            Por favor, ayúdanos a agilizar la confirmación de tu cita haciendo clic en una de las dos opciones para enviar tu comprobante a nuestros asesores.
                        </p>
                        ...
                        <div style={{ marginBottom: "2.5rem", display: "flex", flexDirection: "column", gap: "1rem", alignItems: "center" }}>
                            ...
                            <button 
                                ...
                                style={{ display: "inline-flex", width: "100%", maxWidth: "300px", justifyContent: "center", alignItems: "center", gap: "0.5rem", fontSize: "1.1rem", padding: "1rem 2rem", borderRadius: "12px", cursor: isSending || emailSent ? "not-allowed" : "pointer" }}
                            >
                                {isSending ? "Enviando..." : emailSent ? "✓ Correo Enviado" : "✉️ Continuar por Email"}
                            </button>
                            ...
                            <a 
                                ...
                                style={{ display: "inline-flex", width: "100%", maxWidth: "300px", justifyContent: "center", alignItems: "center", gap: "0.5rem", fontSize: "1.1rem", padding: "1rem 2rem", background: "#25D366", color: "white", textDecoration: "none", borderRadius: "12px", fontWeight: "bold" }}
                            >

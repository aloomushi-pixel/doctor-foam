                        ...
                        {loadingData && !refreshing ? (
                            ...
                            <ResponsiveContainer width="100%" height="85%">
                                <AreaChart data={revenueData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                                    ...
                                    <Tooltip contentStyle={{ borderRadius: "0.5rem", border: "none", boxShadow: "0 4px 15px rgba(0,0,0,0.1)" }} formatter={((value: number) => [`$${value.toLocaleString("es-MX")}`, 'Ingresos']) as any} />
                        ...
                        {loadingData && !refreshing ? (
                            ...
                            <ResponsiveContainer width="100%" height="85%">
                                <BarChart data={chartPackageData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                                    ...
                                    <Tooltip cursor={{ fill: 'rgba(99, 179, 237, 0.1)' }} contentStyle={{ borderRadius: "0.5rem", border: "none", boxShadow: "0 4px 15px rgba(0,0,0,0.1)" }} formatter={((value: number) => [value, 'Reservas']) as any} />
